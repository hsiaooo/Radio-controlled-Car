...
class DC_Motor:
    ...
    #Door
    def close(self):
        GPIO.output(self.ENE, True)
        GPIO.output(self.ENF, True)
        GPIO.output(self.IN9, True)
        GPIO.output(self.IN10, False)
    ...
    def open(self):
        GPIO.output(self.ENE, True)
        GPIO.output(self.ENF, True)
        GPIO.output(self.IN9, False)
        GPIO.output(self.IN10, True)
